...
class SFM(object):
    ...
    def _BaselinePoseEstimation(self, name1, name2):
        ...
        F,mask = cv2.findFundamentalMat(img1pts,img2pts,method=self.opts.fund_method,
                                        param1=self.opts.outlier_thres,param2=self.opts.fund_prob)
    ...
    def _NewViewPoseEstimation(self, name): 
        ...
        pts3d, pts2d, ref_len = _Find2D3DMatches(name)
...
def SetArguments(parser): 
    ...
    parser.add_argument('--dataset', action='store', type=str, default='demo', dest='dataset',
                        help='name of dataset (default: demo)')
    parser.add_argument('--ext', action='store', type=str, default='jpg,png', dest='ext',
                        help='comma separated string of allowed image extensions (default: jpg,png)')
    ...
    parser.add_argument('--calibration_mat', action='store', type=str, default='benchmark',
                        ...
                        help='[benchmark|lg_g3] type of intrinsic camera to use (default: benchmark)')
    ...
    parser.add_argument('--outlier_thres', action='store', type=float, default=.9,
                        dest='outlier_thres',
                        help='threshold value of outlier to be used in fundamental matrix estimation (default: 0.9)')
